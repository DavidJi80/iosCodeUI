...
@implementation MultiTextureGLKVC
...
- (void)fillTexture{
    //获取图片1
    CGImageRef imageRef1 = [[UIImage imageNamed:@"flower.jpg"] CGImage];
    //通过图片数据产生纹理缓存
    ...
    /**
     设置混合EnvMode
     这里创建了两个纹理缓存并且设置了纹理2的envMode为GLKTextureEnvModeDecal，
     GLKTextureEnvModeDecal是和glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);效果一样的。计算公式一致
     */
